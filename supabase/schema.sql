...
-- ============================================================
-- Creative Studio uploads generated visuals server-side with the service role.
-- The bucket is public only for stable image URLs inside generated creative
-- libraries; object paths include UUIDs and are never listed client-side.
