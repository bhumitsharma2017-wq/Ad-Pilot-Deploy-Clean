    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm">
          ...
          {plan !== 'free' && (
            <span className="ml-2 px-2 py-0.5 bg-brand-50 text-brand-600 rounded-full text-xs font-medium capitalize">
              {plan} plan
            </span>
          )}
        </p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              minLength={8}
              className="w-full pl-10 pr-10 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
            />
            <button
              type="button"
