...
export default function ProjectDetailPage() {
  ...
  const handleGenerateCampaigns = async () => {
    ...
    try {
      ...
      toast.success(`${data.campaigns?.length || 0} campaign${data.campaigns?.length === 1 ? '' : 's'} generated!`)
  ...
  const handleRunAnalysis = async () => {
    ...
    try {
      ...
      toast.success(data.test_mode ? 'Test analysis completed!' : 'Analysis completed!')
      await loadProject()
    } catch (error: unknown) {
