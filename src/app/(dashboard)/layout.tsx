      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {mockAi && (
          <div className="px-6 py-2.5 bg-amber-50 border-b border-amber-200 text-sm text-amber-900">
            AI preview mode is active because <code className="font-medium">OPENAI_API_KEY</code> is not configured. Preview data is not real business analysis, ad copy, or rendered creative imagery.
          </div>
        )}
        {previewPlan && (
          <div className="px-6 py-2.5 bg-amber-50 border-b border-amber-200 text-sm text-amber-900">
