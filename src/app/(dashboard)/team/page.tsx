...
import { getClientPlanPreviewSelection, resolvePreviewPlan } from '@/lib/subscription/preview'
...
export default function TeamPage() {
  ...
  const loadTeam = useCallback(async () => {
    try {
      ...
      const isAgencyPlan = userData.subscription?.plan === 'agency'
      setIsAgency(isAgencyPlan)

      if (isAgencyPlan && teamResponse.ok) {
