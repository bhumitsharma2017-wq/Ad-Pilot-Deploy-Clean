...
import { getEffectiveSubscription, PLAN_PREVIEW_COOKIE } from '@/lib/subscription/preview'
...
export default async function DashboardPage() {
  ...
  const projectLimit = effectiveSubscription?.plan === 'free' ? 3 : 'unlimited'
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 stagger-children">
        {[
          ...
          {
            label: 'Plan',
            value: effectiveSubscription?.plan?.toUpperCase() || 'FREE',
            sub: effectiveSubscription?.status === 'active' ? 'Active' : 'Inactive',
            icon: TrendingUp,
            color: 'violet',
          },
          {
